      ...
      for (i = 1; i < this.conversation.length; i = i + 2) {
        ...
        for (f = 0; f < this.word.length; f++) {
          if (this.flag == 0) {
            ...
            this.fullText += "<tr><th> Word </th><th> Abbreviation </th><th> Meaning </th></tr>";
          }
          ...
          if(this.word[f].pos == "IN") meaning = "preposition/subordinating conjunction";
          ...
          if(this.word[f].pos == "VBP") meaning = "verb, present tense not 3rd person singular";
          if(this.word[f].pos == "VBZ") meaning = "verb, present tense with 3rd person singular";
